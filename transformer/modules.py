...
class MultiHeadAttention(nn.Module):
    ...
    def attention(key, query, value, mask, dropout: nn.Dropout):
        ...
        # (batch_size,heads, seq_len,seq_len) --> (batch_size,heads, seq_len,d_k), (batch_size,heads, seq_len,seq_len)
    ...
    def forward(self, q, k, v, mask):
        ...
        # (batch_size,seq_len,d_k) --> (batch_size, seq_len, heads, d_k) --> (batch_size, heads, seq_len,d_k)
